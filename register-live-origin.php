...
if (empty($GLOBALS['em_projekt'][$GLOBALS['em_subclient']]['bolUseDOI'])) {
    ...
    <div class="nw-mb-3' . (!empty($fill['error']['my_new_pass']) ? ' has-error' : '') . '">
            ...
            <div class="nw-relative">
                <div class="nw-absolute nw-right-2 nw-top-3 nw-cursor-pointer nw-z-999 nw-m-auto">
                    <div class="nw-relative">
                                <span id="eye-icon" class="nw-mr-1" onclick="passwordToggle();">
                                    <img id="eye-img"
                                         class="nw-w-6 nw-h-6 nw-overflow-clip-margin-content-box nw-overflow-clip"
                                         alt=""
                                         src="https://www.nw.de/_em_daten/locals/module/nw/_includes/twig/current/public/images/eye.svg">
                                </span>
                    </div>
                </div>
                <input
...
$tpl_text .= '
    ...
    . ' class=" nw-w-full nw-px-1
            ...
            nw-text-tiny
            nw-font-medium
            nw-cursor-pointer nw-py-3 nw-flex nw-justify-center nw-items-center hover:nw-bg-white hover:nw-text-red-500'
...
<script type="text/javascript">
   ...
   function mydaten_check(token) {
    ...
    eyeIcon.attr("src", "https://www.nw.de/_em_daten/locals/module/nw/_includes/twig/current/public/images/eye.svg");
