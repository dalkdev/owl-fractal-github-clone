...
/*if (isset($_SESSION['abo_AboSelected'][0]) && $_SESSION['abo_AboSelected'][0] == 'WTAG_4461') {
    $fill['payment_type'] = 'paypal';
}*/
...
<section class="mt-plus-section" style="margin: 40px 20px 20px 20px">
  <div class="nw-flex nw-justify-center nw-gap-8 ">
    <div class="" style="flex: 0 0 16.666667%;
        max-width: 16.666667%;">
    ...
    <div>
      <div class="nw-text-2xl">
        <h2>Ihr gewünschtes Produkt: <span style="color:#00B4D1 ;font-weight:bold;font-size: 30px;line-height: 32px;"> HK+</span></h2>
          <p>
             <span class="nw-text-base"><b>1 € pro Woche  (ab 2. Jahr 2 € wöchentlich, Abrechnung monatlich) </b></span> 
             <span class="nw-text-base nw-block" >Monatlich kündbar</span>
          </p>
      </div>
    </div>
  </div>
...
if (
    ...
    $tpl_text .= '          
        ...
        ((!empty($GLOBALS['em_projekt'][$GLOBALS['em_subclient']]['abo_' . $_SESSION['abo_AboSelected'][0] . '_paypal_plan_id']) || $unique) ? '
              ...
              <div class="payment-container desc' . (isset($fill['payment_type']) && $fill['payment_type'] !== 'paypal' ? ' hidden' : '') . '" id="desc">
...
$tpl_text .= '
            ...
            <div class="agreement-box">
              ...
              <button type="submit" class="sepa agreement-direkt-zu changepayment' . (isset($fill['payment_type']) && $fill['payment_type'] !== 'paypal' || !empty($fill['hidden_fields']['paypal_agreement_token']) ? '' : ' hidden')
