...
<div class="myonline-login-page-form-container col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-6">
    <form name="my_anmeldung" id="my_anmeldung" class="nw-p-6 nw-border nw-rounded-lg form-horizontal myonline-login-page-form " role="form" action="' . em_text_to_value(em_add_sid_to_query($strFormUrl)) . '" method="post" onsubmit="return em_myonline_check(this)">
        ...
        <div class="myonline-login-page-form-user input-group">
            <input name="my_user" value="" type="text" maxlength="50" size="11" class="form-control" placeholder="Benutzername o. E-Mail">
        </div>
        <div class="myonline-login-page-form-password input-group">
            <input type="password" class="form-control" maxlength="50" size="11" name="my_pass" value="" placeholder="'.(!empty($em_projekt[$em_client]['myonline_passwort']) ? $em_projekt[$em_client]['myonline_passwort'] : 'Passwort'). '">
