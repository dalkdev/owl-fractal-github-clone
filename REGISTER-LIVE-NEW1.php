                ...
                <div class="nw-absolute nw-right-2 nw-cursor-pointer nw-z-999 nw-m-auto">
                    <div class="nw-relative">
                                <span id="eye-icon" class="nw-mr-1 nw-mt-2 nw-flex nw-justify-center" onclick="passwordToggle();">
                                    <img id="eye-img"
                                         class="nw-w-6 nw-h-6 nw-overflow-clip-margin-content-box nw-overflow-clip nw-opacity-60"
                                         alt=""
...
<script type="text/javascript">
   ...
   function mydaten_check(token) {
    ...
    eyeIcon.attr("src", "https://www.nw.de/_em_daten/locals/module/nw/_includes/twig/current/public/images/eye-slash.svg");
